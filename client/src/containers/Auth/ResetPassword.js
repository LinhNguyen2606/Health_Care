...
function ResetPassword() {
    ...
    const handleShowHideOldPassword = () => {
        setData({ isShowOldPassword: !isShowOldPassword });
    };

    const handleShowHideNewPassword = () => {
        setData({ isShowNewPassword: !isShowNewPassword });
    };

    const handleShowHideConfirmPassword = () => {
        setData({ isShowConfirmPassword: !isShowConfirmPassword });
    };
    ...
    const handleResetPassword = async () => {
        ...
        try {
            ...
            if (res && res.errCode !== 0) {
                return setData({ ...data, err: res.errMessage, success: '' });
            }
            if (res && res.errCode === 0) {
                setData({ ...data, err: '', success: res.message });
                toast.success('Password successfully changed!');
            }
        } catch (e) {
            if (e.response) {
                if (e.response.res) {
                    e.response.res.errMessage && setData({ ...data, err: e.response.res.errMessage, success: '' });
                }
            }
        }
    };
                ...
                <div className="row">
                    <div className="authfy-container col-xs-12 col-sm-10 col-md-8 col-lg-6 col-sm-offset-1 col-md-offset-2 col-lg-offset-3">
                        <div
                            ...
                            style={{ float: 'none', height: '480px', marginLeft: '12rem' }}
                        >
                            {/* <!-- authfy-login start --> */}
                            <div className="authfy-login">
                                {/* <!-- panel-login start --> */}
                                <div className="authfy-panel panel-login text-center active">
                                    <div className="authfy-heading" style={{ marginBottom: '15px' }}>
