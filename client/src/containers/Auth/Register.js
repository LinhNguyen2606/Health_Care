...
class Register extends Component {
    ...
    handleRegister = async () => {
        ...
        if (!isMatch(this.state.password, this.state.cf_password)) {
            this.setState({
                fullname: this.state.fullname,
                email: this.state.email,
                password: this.state.password,
                cf_password: this.state.cf_password,
                errMessage: 'Password did not match.',
            });
        }
        ...
        try {
            ...
            if (data && data.errCode === 0) {
                this.props.userRegisterSuccess(data.userData.errMessage);
            }
        } catch (e) {
            if (e.response) {
                if (e.response.data) {
                                        ...
                                        <div className="authfy-panel panel-login text-center active">
                                            <div className="authfy-heading" style={{ marginBottom: '15px' }}>
                                                ...
                                                <p>
                                                    ...
                                                    <Link to="/login" className="lnk-toggler">
                                                        Sign In
                                                    </Link>
                                                </p>
                                            </div>
