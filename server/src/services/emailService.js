...
let getBodyHTMLEmail = (dataSend) => {
    ...
    if (dataSend.language === 'vi') {
        ...
        <p>Nếu các thông tin trên là đúng sự thật vui lòng vào click vào đường link bên dưới để xác nhận và hoàn tất thủ tục đặt lịch khám bệnh.</p>
        <div>
...
let getBodyHTMLEmailRemedy = (dataSend) => {
    ...
    if (dataSend.language === 'vi') {
        result = `
        <h3>Xin chào ${dataSend.patientName}!</h3>
        <p>Bạn nhận được email này vì đã đặt lịch khám bệnh online trên Health Care thành công</p>
